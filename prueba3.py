...
#
# Created: Sat Dec 26 15:05:05 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.status = QtGui.QFrame(self.centralwidget)
        self.status.setGeometry(QtCore.QRect(560, 220, 211, 211))
        ...
        self.audioDEMOD = QtGui.QPushButton(self.centralwidget)
        self.audioDEMOD.setGeometry(QtCore.QRect(150, 310, 115, 27))
        self.audioDEMOD.setObjectName(_fromUtf8("audioDEMOD"))
        self.audioIN = QtGui.QPushButton(self.centralwidget)
        self.audioIN.setGeometry(QtCore.QRect(30, 310, 115, 27))
        self.audioIN.setObjectName(_fromUtf8("audioIN"))
        self.frame = QtGui.QFrame(self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(30, -10, 741, 221))
        ...
        self.frame_2.setGeometry(QtCore.QRect(30, 220, 521, 71))
        ...
        self.frame_4.setGeometry(QtCore.QRect(30, 340, 521, 91))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.v300.setText(_translate("MainWindow", "TextLabel", None))
        self.i300.setText(_translate("MainWindow", "TextLabel", None))
        self.mas15.setText(_translate("MainWindow", "TextLabel", None))
        self.menos15.setText(_translate("MainWindow", "TextLabel", None))
        self.audioDEMOD.setText(_translate("MainWindow", "AUDIO DEMOD", None))
        self.audioIN.setText(_translate("MainWindow", "AUDIO IN", None))
        self.ON.setText(_translate("MainWindow", "ON", None))
        self.OFF.setText(_translate("MainWindow", "OFF", None))
        self.label.setText(_translate("MainWindow", "ALARMAS", None))
        self.fecha.setText(_translate("MainWindow", "FECHA Y HORA", None))
        self.pwrUP.setText(_translate("MainWindow", "+", None))
        self.pwrDOWN.setText(_translate("MainWindow", "-", None))
        self.label_11.setText(_translate("MainWindow", "PWR", None))
        self.label_2.setText(_translate("MainWindow", "POT DIRECTA (KW)", None))
        self.label_3.setText(_translate("MainWindow", "POT REFLEJADA (KW)", None))
        self.label_4.setText(_translate("MainWindow", "PICO (+)", None))
        self.label_5.setText(_translate("MainWindow", "PICO (-)", None))
        self.label_12.setText(_translate("MainWindow", "100%", None))
        self.label_13.setText(_translate("MainWindow", "150%", None))
